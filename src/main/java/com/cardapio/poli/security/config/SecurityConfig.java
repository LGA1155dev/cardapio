    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/refeicao", "/refeicao/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/refeicao/*/comentarios").authenticated()
                        .requestMatchers(HttpMethod.POST, "/refeicao/*/avaliacoes").authenticated()
                        .requestMatchers(HttpMethod.POST, "/refeicao/comentarios/*/likes").authenticated()
                        .requestMatchers("/refeicao", "/refeicao/**").hasRole("ADMIN")
